...
export const Hero= ()=>{
    return(
        <div className='flex max-w-5xl flex-col justify-center items-center py-8 px-4 gap-10 sm:mt-15 md:mt-20 mb-8 sm:mb-12 md:mb-15 z-100000'>
            <h1 className='text-3xl sm:text-4xl lg:text-7xl font-6xl text-center max-w-400 bg-clip-text bg-black
