...
export const Hero= ()=>{
    return(
        <div className='flex max-w-5xl flex-col justify-center items-center py-8 px-4 gap-10 sm:mt-15 md:mt-20 mb-8 sm:mb-12 md:mb-15 z-100000 transition-all duration-500'>
            <h1 className='text-3xl sm:text-4xl lg:text-6xl  font-bold font-lilex text-center max-w-400 bg-clip-text bg-black
                dark:bg-linear-to-b dark:from-neutral-200 dark:to-neutral-500 text-transparent py-4 appear-top
            '>
                <span className='px-px text-transparent bg-clip-text dark:bg-violet-700 bg-neutral-900'>Discover </span>
